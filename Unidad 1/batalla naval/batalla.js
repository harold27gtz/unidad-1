...
//Se agrega una funcion para determinar el area del tablero
...
//Se agrega una funcion para seleccionar los barcos
...
//Generar posición ramdon de ataque
...
function checkShot(event){
    ...
    if(matrixAttack[x][y] === "ship"){
        ...
        alert(" ¡Que mal! tu disparo cayó al agua");
